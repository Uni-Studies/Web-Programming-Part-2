...
namespace API.Controllers
{
    ...
    {
        [HttpGet]
        public IActionResult Get([FromBody] WorkLogsGetRequest model)
        {
            ...
            model.Filter ??= new WorkLogsGetFilterRequest();
            ...
            Expression<Func<WorkLog, bool>> filter = w =>
                ...
                (model.Filter.TimestampFrom == null || w.Timestamp >= model.Filter.TimestampFrom) &&
                (model.Filter.TimestampTo == null || w.Timestamp <= model.Filter.TimestampTo);
